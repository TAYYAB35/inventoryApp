...
const items = [
    ...
    {
        label: 'Products', id: '2', link: '/productlist', icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#000000" fill="none">
    ...
    {
        label: 'Logout', id: '9', link: '/logout', icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#dc2626" fill="none">
                                    ...
                                    items && items.map(item => (
                                        ...
                                        <li key={item.id}>
                                            <a key={item.id} onClick={() => handleNavigation(item.link)} className={`flex hover:bg-gray-50 cursor-pointer items-center gap-x-3.5 py-2 px-2.5 text-sm rounded-lg focus:outline-hidden 
                                                ${location.pathname === item.link ? 'bg-gray-100 text-gray-800 hover:bg-gray-200 ' : ''} ${item.link == '/logout' ? 'text-red-600 font-semibold': ''}`} >
                                                {item.icon}
                                                {item.label}
                                            </a>
                                        </li>
