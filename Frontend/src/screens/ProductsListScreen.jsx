      ...
      <div className="py-4 px-6 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200 bg-slate-50">
        ...
        <div>
          <div className="inline-flex gap-x-2">
            ...
            <a href='products/add' className="py-2 !cursor-pointer px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-teal-600 text-white hover:bg-teal-700 focus:outline-hidden focus:bg-teal-700 disabled:opacity-50 disabled:pointer-events-none">
